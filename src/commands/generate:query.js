const command = {
  ...
  run: async (toolbox) => {
    ...
    await template.generate({
      ...
      target: `./useCases/queries/${parameters.first}/I${parameters.first}UseCase.ts`,
      props: {
    ...
    await template.generate({
      ...
      target: `./useCases/queries/${parameters.first}/${parameters.first}Controller.ts`,
      props: {
        name: parameters.first,
      },
    })
    ...
    await template.generate({
      ...
      target: `./useCases/queries/${parameters.first}/${parameters.first}UseCase.ts`,
      props: {
        name: parameters.first,
      },
    })
    ...
    await template.generate({
      ...
      target: `./useCases/queries/${parameters.first}/${parameters.first}UseCase.spec.ts`,
      props: {
    ...
    await template.generate({
      template: 'UnitTest.spec.ts.ejs',
      target: `./useCases/queries/${parameters.first}/${parameters.first}Controller.spec.ts`,
      props: {
